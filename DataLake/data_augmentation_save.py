...
def data_augmentation(directorie_inpute, directorie_outpute):
    images = []
    image_path = glob.glob(directorie_inpute + "/*.jpg")
    ...
    ibis = 1
    path = directorie_outpute + '/crop/img'
    ...
    ibis = 1
    path = directorie_outpute + '/flip/img'
    ...
    ibis = 1
    path = directorie_outpute + '/blur/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/zoom/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/contrast/img'
    ...
    ibis = 1
    path = directorie_outpute + '/saturation/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/temperature/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/brightness/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/wrappe/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/rotate/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/sun/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/rain/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/quality/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/noise/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/cutout_colores/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/cutout_noise/img'
    for j in range(3):
    ...
    ibis = 1
    path = directorie_outpute + '/coarse_dropout/img'
    for j in range(3):
    ...
    ibis = 0
    path = directorie_outpute + '/get_transforms/img'
    for j in range(3):
