...
DLLEXPORT void initModelWeights(int colsXLen, float *w) {
    using std::cout;
    using std::endl;
...
DLLEXPORT int predictLinearModelClassification(float *modelWeights, int *inputs, int rowsWLen) {
    float res = 0.0f;
...
DLLEXPORT void trainLinear(int **x, int *y, float *w, int rowsXLen, int rowsWLen, int iter) {
