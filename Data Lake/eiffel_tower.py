...
# scrap_insta_loc(user_name="tomghii", password="",tag_loc="tour-eiffel",directorie_outpute="EiffelTower_picture\Insta", file_link="link_eiffel_tower.txt")
#
...
# # web_scraping_Pinterest(url,"EiffelTower_picture\Pinterest")
...
divided_into_subfolders("EiffelTower_picture/all_clean/sub1")
